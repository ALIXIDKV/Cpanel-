...
const apikey = "ptla_dpBSFS7jHEXM2AEMq1ddkZVTkFD2gNu1jpFarCSuD28";
const capikey = "ptlc_MIS7tK8vnkXXOLilTDKEjMfWnMbq32HLSrxvGZD3l1Q";
const domain = "https://alizz.apcb.biz.id";
const nestid = "5";
const egg = "15";
const loc = "1";
